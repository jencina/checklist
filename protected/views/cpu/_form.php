...
<fieldset>
    ...
    <div class="col-md-6">
        <?php echo $form->textFieldGroup($model, 'procesador',
            array(
                'wrapperHtmlOptions' => array('class' => 'col-sm-5'),
            )
        ); ?>
    ...
    <div class="col-md-6">
        <?php echo $form->textFieldGroup($model, 'velocidad',
            array(
                'wrapperHtmlOptions' => array('class' => 'col-sm-5'),
            )
        ); ?>
    ...
    <div class="form-actions col-md-12" >
        ...
        <?php echo CHtml::link('Cancelar',array('cpu/admin'),array('class'=>'btn btn-danger')); ?>
    </div>
